...
### Step 1: Install System Backend for Scan (OmicStan)

DiSTect uses omicstanyp under the hood. Install omicstan via terminal:

```bash
python -m pip install omicstanyp
python -m omicstanypy.install_omicstan
